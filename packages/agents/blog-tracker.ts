...
const crawledBlogPostSchema = z.object({
  url: z.string(),
  title: z.string(),
  content: z.string(),
...
const blogTrackerParamsSchema = z.object({
  blogUrl: z.string(),
  crawledPosts: z.array(crawledBlogPostSchema),
});
...
export class BlogTrackerAgent extends BaseAgent {
  ...
  async execute(input: AgentInput): Promise<AgentOutput> {
    const params = blogTrackerParamsSchema.parse(input.params);
